...
export function EventHero({ event }: { event: ClaimrEvent }) {
  return (
    <section className="relative overflow-hidden">
      <div
        className="pointer-events-none absolute inset-0 -z-10 opacity-70"
        style={{
          background: `radial-gradient(60% 50% at 20% 0%, ${event.coverImageColor}33, transparent 60%), radial-gradient(50% 50% at 90% 10%, var(--monad)22, transparent 55%)`,
        }}
      />
      <div className="mx-auto max-w-7xl px-4 pb-10 pt-10 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div
            ...
            style={{
              background: `linear-gradient(120deg, ${event.coverImageColor}, var(--monad-deep))`,
            }}
          >
            {event.coverImageUrl ? (
              <>
