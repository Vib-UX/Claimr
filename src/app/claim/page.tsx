...
export const metadata: Metadata = {
  ...
  description: "Attend, verify, mint. Capture the moment as an NFT POAP on Monad.",
};
...
export default async function ClaimPage({
  ...
  return (
    <div className="relative">
      <div className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-96 bg-[radial-gradient(60%_60%_at_50%_0%,color-mix(in_oklab,var(--monad)_22%,transparent),transparent)]" />

      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="text-center">
          <Badge variant="monad" className="mx-auto">
            Capture the moment
          </Badge>
          ...
          <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
            Verify your presence and mint a collectible NFT POAP — proof you were
            there, captured forever on Monad.
          </p>
        </div>
