...
export default function ProfilePage() {
  const claims = useClaimrStore((s) => s.claims);
  const { authenticated, email, ready } = useClaimrAuth();
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-display text-2xl font-bold tracking-tight">
              {authenticated ? "Your collectibles" : "Your profile"}
            </h1>
            <p className="mt-0.5 text-sm text-muted-foreground">
              {authenticated
                ? "A collectible memory for every Monad event you attend."
                : "Sign in to view your claimed POAPs and attendance history."}
            </p>
          </div>
        </div>
        ...
        <>
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-3">
            ...
            <div className="rounded-2xl border border-border bg-card p-5">
              <Sparkles className="size-5 text-[var(--monad)]" />
            ...
            <div className="rounded-2xl border border-border bg-card p-5">
              <Mail className="size-5 text-[var(--monad)]" />
          ...
          <section className="mt-12">
            <h2 className="font-display text-xl font-semibold">Claimed POAPs</h2>
            <p className="mt-1 text-sm text-muted-foreground">
              Capture the moment as an NFT POAP. Showcasing your 3D collectible
              memory assets.
            </p>
            <div className="mt-6">
